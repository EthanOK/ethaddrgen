...
- Case-insensitive matching (`--ignore-case`/`-i`): Ignore case when matching
...
ethaddrgen -e '^abc'
```
> Found address: 0xabc214CBc62A7fa953Cd523A6afe6e21AfA16E8d
#### Prefix matching ignoring case

```sh
ethaddrgen -e '^abc' -i
```
> Found address: 0xAbc671c76b90D10ac03222dD26d6C1Ba37451E45
##### Suffix matching
